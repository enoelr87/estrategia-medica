...
export class ContentListComponent {
	...
	constructor(private accountService: AccountService) {
		...
		this.dataList = [
			...
			{
				id: '156',
				link: 'https://mega.nz/folder/aFw33bRb#H7mj-Ev6ktW0SoaPrPFZ7Q',
				name: 'Acidentes Vasculares Cerebrais',
				description: 'Acidentes Vasculares Cerebrais',
				image: 'acidentes-vasculares-cerebrais.jpeg',
				category: 'Neurologia',
			},
			{
				id: '157',
				link: 'https://mega.nz/folder/jUwR1JKa#HaHWIehPhemZVm4SJdwa3g',
				name: 'Cefaleias',
				description: 'Cefaleias',
				image: 'cefaleias.jpeg',
				category: 'Neurologia',
			},
			{
				id: '158',
			...
			{
				id: '159',
				link: 'https://mega.nz/folder/3B5mjJjZ#x_BbFGhqERnDxuDJ9Uocpg',
				name: 'Coma e Alterações da Consciência',
				description: 'Coma e Alterações da Consciência',
				image: 'alteracoes-consciencia.jpeg',
				category: 'Neurologia',
			},
			{
				id: '160',
				link: 'https://mega.nz/folder/aVpFzbjK#ibEViRNnj9toAxuC35ZE7A',
				name: 'Distúrbios do Movimento',
				description: 'Distúrbios do Movimento',
				image: 'disturbios-movimento.jpeg',
				category: 'Neurologia',
			},
			{
				id: '161',
				link: 'https://mega.nz/folder/Kc4UQLBC#xcaQa32GeQ3Wml3162ZClQ',
				name: 'Doenças Neuromusculares',
				description: 'Doenças Neuromusculares',
				image: 'doencas-neuromusculares.jpeg',
				category: 'Neurologia',
			},
			{
				id: '162',
				link: 'https://mega.nz/folder/rZJUzSDR#MIC8QZDJ1Fh_TnVulhrXbQ',
				name: 'Epilepsia',
				description: 'Epilepsia',
				image: 'epilepsia.jpeg',
				category: 'Neurologia',
			},
			{
				id: '163',
				link: 'https://mega.nz/folder/GIozibBZ#eTuJKRNA_1dKcQHUkgVyUg',
				name: 'Traumatismo Cranioencefálico',
				description: 'Traumatismo Cranioencefálico',
				image: 'traumatismo-cranioencefalico.jpeg',
				category: 'Neurologia',
			},
			{
				id: '164',
				link: 'https://mega.nz/folder/DZoCDArY#93KzYKyQoaMjFu8M_5AYZw',
				name: 'Ortopedia e Traumatologia',
				description: 'Ortopedia e Traumatologia',
				image: 'ortopedia-traumatologia.jpeg',
				category: 'Ortopedia',
			},
			{
				id: '165',
				link: 'https://mega.nz/folder/eIBiiaiI#TVs3-znCt4qYiMOywPaiVQ',
				name: 'Conjuntivites',
				description: 'Conjuntivites',
				image: 'conjuntivites.jpeg',
				category: 'Oftalmologia',
			},
			{
				id: '166',
				link: 'https://mega.nz/folder/LE5zQTSA#xhcTQ83KCr8gPy_yiE1pDw',
				name: 'Glaucoma Agudo e Uveíte Anterior',
				description: 'Glaucoma Agudo e Uveíte Anterior',
				image: 'glaucoma-agudo.jpeg',
				category: 'Oftalmologia',
			},
			{
				id: '167',
				link: 'https://mega.nz/folder/HIxwDTLI#N02ZuiHrzZbxkqu1THmxDg',
				name: 'Traumatismo Ocular',
				description: 'Traumatismo Ocular',
				image: 'traumatismo-ocular.jpeg',
				category: 'Oftalmologia',
			},
			{
				id: '168',
				link: 'https://mega.nz/folder/aMpwFa4T#N3KMkWTjS62MkzBkCafBMQ',
				name: 'IVAS (Parte I) - Faringites e Abscesso Cervical',
				description: 'IVAS (Parte I) - Faringites e Abscesso Cervical',
				image: 'faringites-abscesso-cervical.jpeg',
				category: 'Otorrinolaringologia e Cirurgia de Cabeça e Pescoço',
			},
			{
				id: '169',
				link: 'https://mega.nz/folder/aQJHDZaB#ADZtZQJ7Hf0UtYY2Bu0Zfw',
				name: 'IVAS (Parte II) - Otites, Corpo Estranho de Ouvido, Laringites e Linfadenites',
				description: 'IVAS (Parte II) - Otites, Corpo Estranho de Ouvido, Laringites e Linfadenites',
				image: 'otites.jpeg',
				category: 'Otorrinolaringologia e Cirurgia de Cabeça e Pescoço',
			},
			{
				id: '170',
				link: 'https://mega.nz/folder/uMRGnBqD#Li1K-iNh5JMsYchTy9SSKw',
				name: 'IVAS (Parte III) - Rinossinusites, Rinite Alérgica e Epistaxe',
				description: 'IVAS (Parte III) - Rinossinusites, Rinite Alérgica e Epistaxe',
				image: 'rinossinusites.jpeg',
				category: 'Otorrinolaringologia e Cirurgia de Cabeça e Pescoço',
			},
			{
				id: '171',
				link: 'https://mega.nz/folder/OdIRVb7J#5N8v-XL7j2rPkxvZOki5rQ',
				name: 'Distúrbios Ácidos-Base',
				description: 'Distúrbios Ácidos-Base',
				image: 'acidos-base.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '172',
				link: 'https://mega.nz/folder/bVgSAboQ#attNJTBozXtPOrLWByUX4A',
				name: 'Distúrbios do Potássio',
				description: 'Distúrbios do Potássio',
				image: 'disturbios-potassio.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '173',
				link: 'https://mega.nz/folder/yBxQ0Y4A#mRgb68RxK42KQroBmZHnoQ',
				name: 'Distúrbios do Sódio',
				description: 'Distúrbios do Sódio',
				image: 'disturbios-sodio.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '174',
				link: 'https://mega.nz/folder/yVRSRK4C#N3xlax2bwfWxidWoszYyqA',
				name: 'Doença Renal Crônica',
				description: 'Doença Renal Crônica',
				image: 'doenca-renal-cronica.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '175',
				link: 'https://mega.nz/folder/jdpiiTzA#mP0lUQXiVX81wWL_ndX_Aw',
				name: 'Doenças Glomerulares',
				description: 'Doenças Glomerulares',
				image: 'doencas-glomerulares.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '176',
				link: 'https://mega.nz/folder/udQjWLZD#ItvPvS6UW3cnCZOBJwQ1EQ',
				name: 'Infecção do Trato Urinário e Nefrolitíase',
				description: 'Infecção do Trato Urinário e Nefrolitíase',
				image: 'infeccao-tracto-urinario.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '177',
				link: 'https://mega.nz/folder/XNBUmZqB#Ppcv8sqUrK7OFMPg_HmL8Q',
				name: 'Lesão Renal Aguda',
				description: 'Lesão Renal Aguda',
				image: 'lesao-renal-aguda.jpeg',
				category: 'Nefrologia',
			},
			{
				id: '178',
				link: 'https://mega.nz/folder/3EQHyDzK#qhFPziqlzKBJ9dP_68XCyQ',
				name: 'Asma',
				description: 'Asma',
				image: 'asma.jpeg',
			...
			{
				id: '179',
				link: 'https://mega.nz/folder/KZQn2KAY#jLmUCkDyZIXquxZQFs--6Q',
				name: 'Derrame Pleural',
				description: 'Derrame Pleural',
				image: 'derrame-pleural.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '180',
				link: 'https://mega.nz/folder/iVJxhIaA#HeercgcQ6_KlWG2SduMeSA',
				name: 'Doença Pulmonar Obstrutiva Crônica (DPOC)',
				description: 'Doença Pulmonar Obstrutiva Crônica (DPOC)',
				image: 'doenca-pulmonar.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '181',
				link: 'https://mega.nz/folder/vcohwRIR#muBoY8BkN_x0K1HhhuoA9Q',
				name: 'Doenças Pulmonares Intersticiais, Bronquiectasias, Pneumotórax Espontâneo, Pneumoconioses',
				description: 'Doenças Pulmonares Intersticiais, Bronquiectasias, Pneumotórax Espontâneo, Pneumoconioses',
				image: 'doenca-pulmonar.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '182',
				link: 'https://mega.nz/folder/7MQFARqQ#uQqTTULLps6m8wowAPtiZw',
				name: 'Miscelânea - Doenças Pulmonares Intersticiais, Bronquiectasias, Pneumotórax Espontâneo, Pneumoconioses',
				description: 'Miscelânea - Doenças Pulmonares Intersticiais, Bronquiectasias, Pneumotórax Espontâneo, Pneumoconioses',
				image: 'doenca-pulmonar.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '183',
				link: 'https://mega.nz/folder/nQBiwSIS#Mg6zhotC4MzMxeLZiHojYg',
				name: 'Neoplasias Pulmonares',
				description: 'Neoplasias Pulmonares',
				image: 'neoplasias-pulmonares.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '184',
				link: 'https://mega.nz/folder/KNwTRRwL#MfHDi7stJNeh9B61u9TTag',
				name: 'Pneumologia Intensiva',
				description: 'Pneumologia Intensiva',
				image: 'pneumologia-intensiva.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '185',
				link: 'https://mega.nz/folder/jNJkFJ4Z#zTYmSuQ360Nm6cro8FnjAA',
				name: 'Semiologia Respiratória, Tosse, Cuidados Paliativos em Pneumologia',
				description: 'Semiologia Respiratória, Tosse, Cuidados Paliativos em Pneumologia',
				image: 'semiologia-respiratoria.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '186',
				link: 'https://mega.nz/folder/LYQzBZyI#aVX8x2_JanrhB_019guIUA',
				name: 'Tromboembolismo Pulmonar',
				description: 'Tromboembolismo Pulmonar',
				image: 'tromboembolismo-pulmonar.jpeg',
				category: 'Pneumologia',
			},
			{
				id: '187',
				link: 'https://mega.nz/folder/7Q5zGBQC#d_M-46oj1C4RwMqTPuDkHA',
				name: 'Dependência Química',
				description: 'Dependência Química',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '188',
				link: 'https://mega.nz/folder/LZAyzCQI#-mMdB54ZmriWfVNW5LxkXg',
				name: 'Intoxicações Exógenas',
				description: 'Intoxicações Exógenas',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '189',
				link: 'https://mega.nz/folder/CdRmCBYJ#Gvi4iig9YQb4sDxb4g3qhg',
				name: 'Psicofarmacologia',
				description: 'Psicofarmacologia',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '190',
				link: 'https://mega.nz/folder/XJxDhYqa#7APVdMq9YvEksH4xklhuiw',
				name: 'Psicopatologia',
				description: 'Psicopatologia',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '191',
				link: 'https://mega.nz/folder/qAwUDLzL#d02zjOngSfwegqLj2CyiYA',
			...
			{
				id: '192',
				link: 'https://mega.nz/folder/yA5ACKJa#gWaQyVmOpkNscca1LHFRig',
				name: 'Psiquiatria Social e Reforma Psiquiátrica',
				description: 'Psiquiatria Social e Reforma Psiquiátrica',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '193',
				link: 'https://mega.nz/folder/nFx2WRYL#djE2mH-8q2njJpV5RAimUA',
				name: 'Transtorno de Personalidade',
				description: 'Transtorno de Personalidade',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '194',
				link: 'https://mega.nz/folder/yIBQiL7Y#k018g084TlKHIki_T2eJNg',
				name: 'Transtorno Obsessivo-Compulsivo (TOC) e Transtornos Relacionados ao Estresse (1)',
				description: 'Transtorno Obsessivo-Compulsivo (TOC) e Transtornos Relacionados ao Estresse (1)',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '195',
				link: 'https://mega.nz/folder/mRQXBIBa#KAJuo4inT97aaSD6u1Whjg',
				name: 'Transtornos Alimentares',
				description: 'Transtornos Alimentares',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '196',
				link: 'https://mega.nz/folder/XMh32KbK#yb_RaCtN588Jyaj736hSZA',
			...
			{
				id: '197',
				link: 'https://mega.nz/folder/zcJlWJyb#krLoLvtg2VBS-V5eyCTVzw',
				name: 'Transtornos do Humor',
				description: 'Transtornos do Humor',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '198',
				link: 'https://mega.nz/folder/DJZQUIZR#Gsh9hDrWw0KCQ-JlkcOPgw',
				name: 'Transtornos Psicóticos',
				description: 'Transtornos Psicóticos',
				image: 'dependencia-quimica.jpeg',
				category: 'Psiquiatria',
			},
			{
				id: '199',
				link: 'https://mega.nz/folder/TVY1lJCR#Nt6SccJTlbvRcTXglV6VNQ',
				name: 'Artropatias Inflamatórias',
				description: 'Artropatias Inflamatórias',
				image: 'artropatias-inflamatorias.jpeg',
				category: 'Reumatologia',
			},
			{
				id: '200',
				link: 'https://mega.nz/folder/LNJC1DqK#TogqKEb4mHBUwKBJCqZ0og',
				name: 'Doenças Autoimunes do Tecido Conjuntivo (LES, SAF, ES, Sjögren, DMTC, DM_PM)',
				description: 'Doenças Autoimunes do Tecido Conjuntivo (LES, SAF, ES, Sjögren, DMTC, DM_PM)',
				image: 'doencas-autoimunes.jpeg',
				category: 'Reumatologia',
			},
			{
				id: '201',
				link: 'https://mega.nz/folder/GBQVWZTC#kw0ySnbNxc-zo2ofTt1POw',
				name: 'Miscelânea',
				description: 'Miscelânea',
				image: 'artropatias-inflamatorias.jpeg',
				category: 'Reumatologia',
			},
			{
				id: '202',
				link: 'https://mega.nz/folder/fNQFxbaA#eCyy32F37FgnlxCbtn22nA',
				name: 'Outras Artropatias',
				description: 'Outras Artropatias',
				image: 'artropatias-inflamatorias.jpeg',
				category: 'Reumatologia',
			},
			{
				id: '203',
				link: 'https://mega.nz/folder/2ZxBnDbC#YATKgy4SNpvyYaBSiXVPhw',
				name: 'Síndromes Dolorosas',
				description: 'Síndromes Dolorosas',
				image: 'sindromes-dolorosas.jpeg',
				category: 'Reumatologia',
			},
			{
				id: '204',
				link: 'https://mega.nz/folder/vEZCGaoB#yMbSjVOXWR7mm19w9AJ5Dg',
				name: 'Vasculites',
				description: 'Vasculites',
			...
			},
			{
				id: '205',
				link: 'https://mega.nz/folder/HBhgTLyQ#44CLP61jwdwo3sfQOnsfVg',
				name: 'IRAS, Antibióticos e Microbiologia',
				description: 'IRAS, Antibióticos e Microbiologia',
				image: 'iras.jpeg',
				category: 'Infectologia',
			},
			{
				id: '206',
				link: 'https://mega.nz/folder/WAYFRbib#zj-8Kzzxig5GeOuV4oGTpA',
				name: 'Leptospirose',
				description: 'Leptospirose',
				image: 'leptospirose.jpeg',
				category: 'Infectologia',
			},
			{
				id: '207',
				link: 'https://mega.nz/folder/CdIyQJrT#f6VNRIsGdzFrSZAvuv9Rsw',
				name: 'Malária',
				description: 'Malária',
				image: 'malaria.jpeg',
				category: 'Infectologia',
			...
			{
				id: '208',
				link: 'https://mega.nz/folder/XEZESTSb#yBZlIMzSmJuOw8BIbMBmng',
				name: 'Micoses Invasivas',
				description: 'Micoses Invasivas',
				image: 'micoses-invasivas.jpeg',
				category: 'Infectologia',
			},
			{
				id: '209',
				link: 'https://mega.nz/folder/3BBDGDJL#AQUk2tb16-coznK4H909yA',
				name: 'Mordedura, Raiva e Tétano',
				description: 'Mordedura, Raiva e Tétano',
				image: 'mordedura.jpeg',
				category: 'Infectologia',
			},
			{
				id: '210',
				link: 'https://mega.nz/folder/HJJEHQwA#QdmEY71t4tR3MxHnAJ60Dw',
				name: 'Parasitoses',
				description: 'Parasitoses',
				image: 'parasitoses.jpeg',
				category: 'Infectologia',
			},
			{
				id: '211',
				link: 'https://mega.nz/folder/LcAi3BRL#EkgITBzLPhET2K56Cyl3Sg',
				name: 'Pneumonias',
				description: 'Pneumonias',
				image: 'pneumonias.jpeg',
				category: 'Infectologia',
			},
			{
				id: '212',
				link: 'https://mega.nz/folder/2FJ3QbwA#JX8WA2fhdUs2LBGuCfCrWg',
				name: 'Sepse + Imunodeficiências',
				description: 'Sepse + Imunodeficiências',
				image: 'sepse.jpeg',
				category: 'Infectologia',
			},
			{
				id: '213',
				link: 'https://mega.nz/folder/KRBjhC6R#01HIMCMJUvonucyw7aZWaQ',
				name: 'Sífilis Uretrites',
				description: 'Sífilis Uretrites',
				image: 'sifilis-uretrites.jpeg',
				category: 'Infectologia',
			},
			{
				id: '214',
				link: 'https://mega.nz/folder/XdQUxYAS#sWoqvK92AEbBSPRE4WEHWA',
				name: 'Tuberculose',
				description: 'Tuberculose',
				image: 'tuberculose.jpeg',
				category: 'Infectologia',
